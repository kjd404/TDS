...
public class AdminDrawBulletsTest {
    ...
    private static class StubInputService extends com.badlogic.gdx.InputAdapter implements InputService {
        @Override public boolean isActionPressed(InputService.Action action) { return false; }
        @Override public void register(InputService.Action action, Runnable callback) { }
        @Override public void bind(InputService.Action action, int code) { }
    }
    ...
    private static class RecordingParticleSystem implements ParticleSystem {
        ...
        @Override public void draw(com.badlogic.gdx.graphics.g2d.SpriteBatch batch) { drawn = true; }
    }
